#
#  Be sure to run `pod spec lint TestingWithXCSplunk.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "Zindal"
  # spec.authors            = { "Zindal" => "jindalp@splunk.com" }
  # spec.social_media_url   = "https://twitter.com/Zindal"
